...
export class AddBusiness1660183539503 implements MigrationInterface {
    name = 'AddBusiness1660183539503'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`businesses\` (\`id\` varchar(36) NOT NULL, \`user_id\` varchar(255) NOT NULL, \`business_name\` varchar(191) NOT NULL, \`business_email\` varchar(191) NULL, \`position\` varchar(191) NULL, \`location\` int NOT NULL DEFAULT '0', \`is_deleted\` tinyint NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`REL_cbb98c2d1e4c7bdf6eabc305c4\` (\`user_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`businesses\` ADD CONSTRAINT \`FK_cbb98c2d1e4c7bdf6eabc305c42\` FOREIGN KEY (\`user_id\`) REFERENCES \`dev_users\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`product_keys\` ADD CONSTRAINT \`FK_d1204b0743d3790db2e372b06b0\` FOREIGN KEY (\`user_id\`) REFERENCES \`dev_users\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`access_tokens\` ADD CONSTRAINT \`FK_09ee750a035b06e0c7f0704687e\` FOREIGN KEY (\`user_id\`) REFERENCES \`dev_users\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`businesses\` DROP FOREIGN KEY \`FK_cbb98c2d1e4c7bdf6eabc305c42\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_cbb98c2d1e4c7bdf6eabc305c4\` ON \`businesses\``);
