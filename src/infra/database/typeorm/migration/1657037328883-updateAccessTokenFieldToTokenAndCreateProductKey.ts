...
export class updateAccessTokenFieldToTokenAndCreateProductKey1657037328883 implements MigrationInterface {
    name = 'updateAccessTokenFieldToTokenAndCreateProductKey1657037328883'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // await queryRunner.query(`ALTER TABLE \`dev_products\` CHANGE \`price\` \`price\` decimal(10,8) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dev_products\` CHANGE \`price\` \`price\` decimal(10,2) NOT NULL`);
