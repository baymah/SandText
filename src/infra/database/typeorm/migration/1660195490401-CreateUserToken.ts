...
export class CreateUserToken1660195490401 implements MigrationInterface {
    name = 'CreateUserToken1660195490401'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`dev_tokens\` (\`id\` varchar(36) NOT NULL, \`user_id\` varchar(255) NOT NULL, \`type\` enum ('email_verify', 'password_reset') NOT NULL, \`expires_at\` datetime NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_tokens\` ADD CONSTRAINT \`FK_115a64b0db661b17e4625640a96\` FOREIGN KEY (\`user_id\`) REFERENCES \`dev_users\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
