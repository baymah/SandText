...
export class removebrandIdrelationonproduct1655509280859 implements MigrationInterface {
    name = 'removebrandIdrelationonproduct1655509280859'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // await queryRunner.query(`ALTER TABLE \`product_pictures\` ADD \`product_id\` varchar(36) NULL`);
