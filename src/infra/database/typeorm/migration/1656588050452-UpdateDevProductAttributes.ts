...
export class UpdateDevProductAttributes1656588050452 implements MigrationInterface {
    name = 'UpdateDevProductAttributes1656588050452'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dev_product_attributes\` ADD \`is_deleted\` tinyint NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`dev_product_attributes\` ADD \`quantity\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_products\` CHANGE \`status\` \`status\` int NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dev_products\` CHANGE \`status\` \`status\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_product_attributes\` DROP COLUMN \`quantity\``);
        await queryRunner.query(`ALTER TABLE \`dev_product_attributes\` DROP COLUMN \`is_deleted\``);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_cdee90b283c211169a40283ddb\` ON \`dev_products\` (\`status\`)`);
