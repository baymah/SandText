...
export class UpdateBusinessIsDeletedDefaultValue1660188424250 implements MigrationInterface {
    name = 'UpdateBusinessIsDeletedDefaultValue1660188424250'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`businesses\` CHANGE \`is_deleted\` \`is_deleted\` tinyint NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`product_pictures\` ADD CONSTRAINT \`FK_f07e63921c0d66f9ecd3a73868f\` FOREIGN KEY (\`product_id\`) REFERENCES \`products\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`businesses\` CHANGE \`is_deleted\` \`is_deleted\` tinyint NOT NULL`);
