...
export class updateUniqueConstraintStatusOnColumnNameAndCompanynameOnDevUser1657037797472 implements MigrationInterface {
    name = 'updateUniqueConstraintStatusOnColumnNameAndCompanynameOnDevUser1657037797472'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dev_users\` ADD UNIQUE INDEX \`IDX_7690930e45971bca5f46e939d1\` (\`company_name\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`product_pictures\` ADD CONSTRAINT \`FK_f07e63921c0d66f9ecd3a73868f\` FOREIGN KEY (\`product_id\`) REFERENCES \`products\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`dev_users\` DROP INDEX \`IDX_7690930e45971bca5f46e939d1\``);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_072d43c4f2ff483abd723227fa\` ON \`dev_users\` (\`name\`)`);
