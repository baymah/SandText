...
export class addedCompanyNameAndTheProductNicheToDevUser1656509738740 implements MigrationInterface {
    name = 'addedCompanyNameAndTheProductNicheToDevUser1656509738740'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dev_access_tokens\` DROP COLUMN \`status\``);
        await queryRunner.query(`ALTER TABLE \`dev_access_tokens\` ADD \`status\` int NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_pub_keys\` DROP COLUMN \`status\``);
        await queryRunner.query(`ALTER TABLE \`dev_pub_keys\` ADD \`status\` int NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`product_pictures\` DROP FOREIGN KEY \`FK_f07e63921c0d66f9ecd3a73868f\``);
        await queryRunner.query(`ALTER TABLE \`dev_pub_keys\` DROP COLUMN \`status\``);
        await queryRunner.query(`ALTER TABLE \`dev_pub_keys\` ADD \`status\` varchar(191) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_access_tokens\` DROP COLUMN \`status\``);
        await queryRunner.query(`ALTER TABLE \`dev_access_tokens\` ADD \`status\` varchar(191) NOT NULL`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_90f6995837d643aab6674bf9b9\` ON \`dev_pub_keys\` (\`status\`)`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_dcab0607ca869e07627e420eda\` ON \`dev_access_tokens\` (\`status\`)`);
