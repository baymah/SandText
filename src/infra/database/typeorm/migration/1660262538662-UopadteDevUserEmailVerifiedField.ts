...
export class UopadteDevUserEmailVerifiedField1660262538662 implements MigrationInterface {
    name = 'UopadteDevUserEmailVerifiedField1660262538662'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dev_users\` ADD \`email_verified\` tinyint NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dev_users\` DROP COLUMN \`email_verified\``);
