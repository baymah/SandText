...
export class createDevProductDevPromoVideoProductAndProductAttributes1656586418265 implements MigrationInterface {
    name = 'createDevProductDevPromoVideoProductAndProductAttributes1656586418265'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`dev_product_attributes\` (\`id\` varchar(36) NOT NULL, \`product_id\` varchar(191) NOT NULL, \`color\` varchar(191) NOT NULL, \`size\` varchar(191) NOT NULL, \`weight\` varchar(191) NOT NULL, \`availability\` tinyint NOT NULL DEFAULT '1', \`status\` int NOT NULL DEFAULT '0', \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_products\` DROP COLUMN \`brand_id\``);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_products\` ADD \`brand\` varchar(191) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`dev_products\` ADD \`subcategory_id\` varchar(191) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dev_products\` DROP COLUMN \`subcategory_id\``);
        await queryRunner.query(`ALTER TABLE \`dev_products\` DROP COLUMN \`brand\``);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_products\` ADD \`brand_id\` varchar(191) NOT NULL`);
