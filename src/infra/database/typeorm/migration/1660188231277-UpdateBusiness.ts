...
export class UpdateBusiness1660188231277 implements MigrationInterface {
    name = 'UpdateBusiness1660188231277'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`businesses\` ADD \`videoRange\` varchar(191) NULL`);
        await queryRunner.query(`ALTER TABLE \`businesses\` ADD \`uploadFrequency\` varchar(191) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`businesses\` ADD \`location\` varchar(191) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`businesses\` DROP COLUMN \`location\``);
        await queryRunner.query(`ALTER TABLE \`businesses\` ADD \`location\` int NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE \`businesses\` DROP COLUMN \`uploadFrequency\``);
        await queryRunner.query(`ALTER TABLE \`businesses\` DROP COLUMN \`videoRange\``);
