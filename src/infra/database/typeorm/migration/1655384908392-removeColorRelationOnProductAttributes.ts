...
export class removeColorRelationOnProductAttributes1655384908392 implements MigrationInterface {
    name = 'removeColorRelationOnProductAttributes1655384908392'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `product_attributes` DROP FOREIGN KEY `FK_16e086c6474004ff929f81d3783`");
        await queryRunner.query("ALTER TABLE `product_attributes` CHANGE `color_id` `color` varchar(191) NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `products` DROP COLUMN `category_id`");
        await queryRunner.query("ALTER TABLE `products` ADD `category_id` varchar(191) NOT NULL");
        ...
        await queryRunner.query("ALTER TABLE `product_attributes` CHANGE `color` `color_id` varchar(191) NOT NULL");
        await queryRunner.query("ALTER TABLE `product_attributes` ADD CONSTRAINT `FK_16e086c6474004ff929f81d3783` FOREIGN KEY (`color_id`) REFERENCES `colors`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
    }
