...
export class addOrderIdcolumnToTheOrderTable1656461703465 implements MigrationInterface {
    name = 'addOrderIdcolumnToTheOrderTable1656461703465'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`dev_access_tokens\` (\`id\` varchar(36) NOT NULL, \`access_token\` varchar(191) NOT NULL, \`status\` varchar(191) NOT NULL, \`user_id\` varchar(191) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_2b1d05c7f326a0794015eaec8e\` (\`access_token\`), UNIQUE INDEX \`IDX_dcab0607ca869e07627e420eda\` (\`status\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`dev_users\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(191) NOT NULL, \`email\` varchar(191) NOT NULL, \`phone\` varchar(191) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_072d43c4f2ff483abd723227fa\` (\`name\`), UNIQUE INDEX \`IDX_694224f3fdc3f391717f226784\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`dev_pub_keys\` (\`id\` varchar(36) NOT NULL, \`public_key\` varchar(191) NOT NULL, \`status\` varchar(191) NOT NULL, \`user_id\` varchar(191) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_81d5bd67ab22dbecfc0a354b86\` (\`public_key\`), UNIQUE INDEX \`IDX_90f6995837d643aab6674bf9b9\` (\`status\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_90f6995837d643aab6674bf9b9\` ON \`dev_pub_keys\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_072d43c4f2ff483abd723227fa\` ON \`dev_users\``);
        await queryRunner.query(`DROP TABLE \`dev_users\``);
        await queryRunner.query(`DROP INDEX \`IDX_dcab0607ca869e07627e420eda\` ON \`dev_access_tokens\``);
        await queryRunner.query(`DROP INDEX \`IDX_2b1d05c7f326a0794015eaec8e\` ON \`dev_access_tokens\``);
        await queryRunner.query(`DROP TABLE \`dev_access_tokens\``);
