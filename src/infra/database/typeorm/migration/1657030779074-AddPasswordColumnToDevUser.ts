...
export class AddPasswordColumnToDevUser1657030779074 implements MigrationInterface {
    name = 'AddPasswordColumnToDevUser1657030779074'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dev_users\` ADD \`password\` varchar(191) NOT NULL`);
        ...
        // await queryRunner.query(`ALTER TABLE \`dev_access_tokens\` ADD UNIQUE INDEX \`IDX_6a0903488f6d31d52fdaba2cde\` (\`user_id\`)`);
        ...
        // await queryRunner.query(`CREATE UNIQUE INDEX \`REL_6a0903488f6d31d52fdaba2cde\` ON \`dev_access_tokens\` (\`user_id\`)`);
        ...
        // await queryRunner.query(`ALTER TABLE \`dev_access_tokens\` ADD CONSTRAINT \`FK_6a0903488f6d31d52fdaba2cde1\` FOREIGN KEY (\`user_id\`) REFERENCES \`dev_users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_items\` DROP FOREIGN KEY \`FK_145532db85752b29c57d2b7b1f1\``);
        await queryRunner.query(`ALTER TABLE \`product_pictures\` DROP FOREIGN KEY \`FK_f07e63921c0d66f9ecd3a73868f\``);
        await queryRunner.query(`ALTER TABLE \`dev_access_tokens\` DROP FOREIGN KEY \`FK_6a0903488f6d31d52fdaba2cde1\``);
        await queryRunner.query(`ALTER TABLE \`dev_pub_keys\` DROP FOREIGN KEY \`FK_e8a1671dfea3f6358f6006f45f3\``);
        await queryRunner.query(`DROP INDEX \`REL_6a0903488f6d31d52fdaba2cde\` ON \`dev_access_tokens\``);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_access_tokens\` DROP INDEX \`IDX_6a0903488f6d31d52fdaba2cde\``);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_users\` DROP COLUMN \`password\``);
