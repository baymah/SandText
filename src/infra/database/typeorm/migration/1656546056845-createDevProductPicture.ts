...
export class createDevProductPicture1656546056845 implements MigrationInterface {
    name = 'createDevProductPicture1656546056845'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`dev_product_pictures\` (\`id\` varchar(36) NOT NULL, \`picture\` varchar(191) NOT NULL, \`thumbnail\` varchar(191) NOT NULL, \`status\` int NOT NULL DEFAULT '0', \`is_deleted\` tinyint NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`product_id\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        // await queryRunner.query(`ALTER TABLE \`products\` DROP COLUMN \`product_processed_meta\``);
        // await queryRunner.query(`ALTER TABLE \`products\` DROP COLUMN \`product_processed_status\``);
        ...
        // await queryRunner.query(`ALTER TABLE \`products\` ADD \`brand\` varchar(191) NOT NULL`);
        // await queryRunner.query(`ALTER TABLE \`products\` ADD \`product_processed_status\` int NOT NULL`);
        // await queryRunner.query(`ALTER TABLE \`products\` ADD \`product_processed_meta\` longtext NOT NULL`);
        // await queryRunner.query(`ALTER TABLE \`products\` ADD \`color_id\` varchar(191) NOT NULL`);
        // await queryRunner.query(`ALTER TABLE \`products\` ADD \`shop_id\` varchar(191) NOT NULL`);
        // await queryRunner.query(`ALTER TABLE \`products\` ADD \`products_status\` int NOT NULL DEFAULT '0'`);
        // await queryRunner.query(`ALTER TABLE \`products\` ADD \`sub_categories_id\` varchar(191) NOT NULL`);
        // await queryRunner.query(`ALTER TABLE \`products\` ADD \`brand_id\` varchar(191) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`products\` ADD \`shop_id\` varchar(191) NULL`);
        await queryRunner.query(`ALTER TABLE \`products\` ADD \`products_status\` int NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`products\` ADD \`product_processed_status\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`products\` ADD \`product_processed_meta\` longtext NULL`);
