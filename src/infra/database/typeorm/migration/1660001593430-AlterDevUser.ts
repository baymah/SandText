...
export class AlterDevUser1660001593430 implements MigrationInterface {
    name = 'AlterDevUser1660001593430'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dev_users\` DROP COLUMN \`company_name\``);
        await queryRunner.query(`ALTER TABLE \`dev_users\` DROP COLUMN \`name\``);
        await queryRunner.query(`ALTER TABLE \`dev_users\` DROP COLUMN \`phone\``);
        await queryRunner.query(`ALTER TABLE \`dev_users\` DROP COLUMN \`what_you_are_building\``);
        ...
        // await queryRunner.query(`ALTER TABLE \`dev_products\` DROP COLUMN \`thumbnail\``);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_users\` ADD \`firstname\` varchar(191) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`dev_users\` ADD \`lastname\` varchar(191) NOT NULL`);
        ...
        // await queryRunner.query(`ALTER TABLE \`key_stores\` ADD UNIQUE INDEX \`IDX_1ce431ce46459e0b56b701919d\` (\`user_id\`)`);
        ...
        // await queryRunner.query(`ALTER TABLE \`dev_pub_keys\` ADD UNIQUE INDEX \`IDX_e8a1671dfea3f6358f6006f45f\` (\`user_id\`)`);
        // await queryRunner.query(`CREATE UNIQUE INDEX \`REL_1ce431ce46459e0b56b701919d\` ON \`key_stores\` (\`user_id\`)`);
        // await queryRunner.query(`CREATE UNIQUE INDEX \`REL_e8a1671dfea3f6358f6006f45f\` ON \`dev_pub_keys\` (\`user_id\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dev_pub_keys\` DROP INDEX \`IDX_e8a1671dfea3f6358f6006f45f\``);
        ...
        await queryRunner.query(`ALTER TABLE \`key_stores\` DROP INDEX \`IDX_1ce431ce46459e0b56b701919d\``);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_users\` DROP COLUMN \`lastname\``);
        await queryRunner.query(`ALTER TABLE \`dev_users\` DROP COLUMN \`firstname\``);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_products\` ADD \`thumbnail\` varchar(191) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`dev_users\` ADD \`what_you_are_building\` text NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`dev_users\` ADD \`phone\` varchar(191) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`dev_users\` ADD \`name\` varchar(191) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`dev_users\` ADD \`company_name\` varchar(191) NOT NULL`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_7690930e45971bca5f46e939d1\` ON \`dev_users\` (\`company_name\`)`);
