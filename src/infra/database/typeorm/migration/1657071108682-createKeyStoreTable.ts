...
export class createKeyStoreTable1657071108682 implements MigrationInterface {
    name = 'createKeyStoreTable1657071108682'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // UNIQUE INDEX \`REL_1ce431ce46459e0b56b701919d\` (\`user_id\`),
        await queryRunner.query(`CREATE TABLE \`key_stores\` (\`id\` varchar(36) NOT NULL, \`primary_key\` varchar(191) NOT NULL, \`secondary_key\` varchar(191) NOT NULL, \`status\` int NOT NULL DEFAULT '0', \`user_id\` varchar(191) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
