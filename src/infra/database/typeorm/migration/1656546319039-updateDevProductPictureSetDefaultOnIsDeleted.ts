...
export class updateDevProductPictureSetDefaultOnIsDeleted1656546319039 implements MigrationInterface {
    name = 'updateDevProductPictureSetDefaultOnIsDeleted1656546319039'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // await queryRunner.query(`ALTER TABLE \`products\` CHANGE \`is_deleted\` \`is_deleted\` tinyint NOT NULL DEFAULT '0'`);
        // await queryRunner.query(`ALTER TABLE \`products\` CHANGE \`updated_at\` \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`dev_product_pictures\` CHANGE \`is_deleted\` \`is_deleted\` tinyint NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dev_product_pictures\` CHANGE \`is_deleted\` \`is_deleted\` tinyint NOT NULL`);
